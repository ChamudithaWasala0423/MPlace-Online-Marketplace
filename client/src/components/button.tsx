...
const Button: React.FC<ButtonProps> = ({ title, variant, onClick }) => {
  ...
  const variantStyles = {
    ...
    secondary: 'h-[56px] px-12 py-4 border border-[#00000080] text-black hover:border-[#7D8184] hover:text-[#7D8184] w-auto',
    login: 'h-[56px] px-12 py-4 bg-[#7e2ee7] rounded justify-center items-center gap-2.5 inline-flex w-[100%]'
  };
