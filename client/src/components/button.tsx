...
const Button: React.FC<ButtonProps> = ({ title, variant, onClick }) => {
  const baseStyles = 'flex items-center justify-center rounded-md gap-2 w-full';
  ...
  const variantStyles = {
    ...
    login: 'h-[56px] w-[551px] py-4 bg-[#7e2ee7] rounded justify-center items-center gap-2.5 inline-flex'
  };
