  ...
  return (
    <div className="w-full h-screen flex flex-col bg-white">
      ...
      <div className="flex flex-grow">
        ...
        <div className="flex-shrink-0 w-[720px] h-[904px] flex justify-center items-center bg-[#f3ebff]">
          <div className="w-[720px] p-8 bg-[#f3ebff]rounded-lg  ">
            ...
            <Button variant="login" title="Log In" className="w-full mt-6" />
            </div>
       ...
       {/* Footer (Placeholder) */}
       <div className="w-full h-[1440px] bg-gray-200 flex items-center justify-center">
