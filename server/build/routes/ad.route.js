...
//upload Ad
adRouter.post("/upload-ad", (0, auth_1.authorizeRoles)("user"), (req, res, next) => {
    (0, ads_controller_1.uploadAd)(req, res, next);
});
//Edit Ad
adRouter.put("/edit-ad/:id", (req, res, next) => {
...
adRouter.get("/get-single-ad/:id", (req, res, next) => {
...
//delete ad
adRouter.delete("/delete-ad/:id", (req, res, next) => {
    (0, ads_controller_1.deleteAd)(req, res, next);
});
//add question in course
adRouter.put("/add-question", (req, res, next) => {
